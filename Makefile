...
all: cast-vote admin-keygen

%.o: %.cpp $(foreach part, $(PARTS), $(part).h) paillier.h
	$(CC) $< -c -o $@ $(CFLAGS)

cast-vote admin-keygen: %: $(foreach part, $(PARTS), $(part).o) %.o
...
clean:
	rm $(foreach part, $(PARTS), $(part).o) tests cast-vote admin-keygen cast-vote.o admin-keygen.o; true
